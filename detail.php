        ...
        <?php
            ...
            if($total > 0){
                while($result = mysqli_fetch_assoc($query)){
                    select($result['id'],$result['Images'],$result['M_name'], $result['V_number'], $result['Seat'], $result['Rent'], $result['Days']);
                }
            }
            else{
...
<?php
    function select($id,$Images,$M_name,$V_number,$Seat,$Rent,$Days){
        $element= "
            <div class='card-select'>
                <img src='admin/images/$Images' alt='car image'>
                ...
                <form action='rent.php?id=$id' method='post'>
                    ...
                    <div class='error-text'>This is an error message</div>
                        ...
                        <div class=' days'>
                            ...
                            <br>
                            <h5>Last Date :</h5>
                            <input type='date' name='la_date' required>
                        </div>
